        ...
        <div className="flex flex-col xl:grid xl:grid-cols-12 gap-4 sm:gap-6 xl:gap-8">
          ...
          <div className="xl:col-span-8 space-y-4 sm:space-y-6">
            ...
            <Card
              ...
              className="xl:hidden border-0 shadow-xl overflow-hidden bg-gradient-to-br from-card via-card to-accent/20"
            >
              <CardContent className="p-4 sm:p-5 md:p-6 space-y-4 sm:space-y-6">
                <div>
                  <h3 className="text-sm sm:text-base font-bold text-foreground mb-3 sm:mb-4 text-center uppercase tracking-wide">
                    {language === "en" ? "Your Destination" : "Destinacioni Juaj"}
                  </h3>
                  <div className="aspect-square w-full max-w-[220px] sm:max-w-[260px] md:max-w-[300px] mx-auto">
                    <InteractiveGlobe
                  ...
                  <p className="text-xs sm:text-sm text-muted-foreground text-center mt-3 sm:mt-4 leading-tight text-pretty">
                    {language === "en"
            ...
            <div className="xl:sticky xl:top-24 space-y-4">
              ...
              <Card className="border-0 shadow-xl overflow-hidden bg-gradient-to-br from-card via-card to-accent/20">
                <CardContent className="p-4">
                  <h3 className="text-sm font-bold text-foreground mb-3 text-center uppercase tracking-wide">
                    {language === "en" ? "Your Destination" : "Destinacioni Juaj"}
                  </h3>
                  ...
                  <p className="text-[10px] text-muted-foreground text-center mt-2 leading-tight text-pretty">
                    {language === "en"
                      ? "Watch as the globe locates your destination"
                      : "Shikoni ndërsa globi gjen destinacionin tuaj"}
                  </p>
