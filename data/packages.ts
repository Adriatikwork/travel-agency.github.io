  ...
  packages: [
    {
      ...
      title: { en: "Bansko Family Ski Adventure", sq: "Aventura Familjare e Skijimit në Bansko" },
      destinationId: "dest-bansko-jan-01",
      summary: { en: "5 nights with ski passes, equipment rental, and family activities in the snow.", sq: "5 netë me ski pass, qira pajisjesh dhe aktivitete familjare në borë." },
    ...
    },
    {
      ...
      title: { en: "Barcelona Mediterranean Romance", sq: "Romancë Mesdhetare në Barcelonë" },
      destinationId: "dest-barcelona-dec-01",
      summary: { en: "2 nights with tapas tours, Gaudí architecture visits, and beachfront dining.", sq: "2 netë me turne tapas, vizita në arkitekturën e Gaudít dhe darke në bregdet." },
      image: "/placeholder.svg?height=300&width=500",
      price: 299,
      duration: 2,
      inclusions: {
        en: ["Boutique Hotel", "Tapas Tour", "Sagrada Familia Tickets", "Beach Club Access", "Airport Transfers"],
        sq: ["Hotel Boutique", "Tur Tapas", "Bileta për Sagrada Familia", "Qasje në Beach Club", "Transferta Aeroporti"],
      },
