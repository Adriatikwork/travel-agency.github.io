  ...
  destinations: [
    {
      ...
      descriptionLong: {
        en: "5 nights of relaxation, snow and entertainment for the whole family! Comfortable accommodation, ski slopes very close and activities for everyone. A perfect start to the new year.",
        sq: "5 netë relaksim, borë dhe argëtim për të gjithë familjen! Akomodim komod, pista skijimi shumë afër dhe aktivitete për të gjithë."
      },
    ...
    },
    {
      ...
      descriptionLong: {
        ...
        sq: "Përjetoni atmosferën magjike të Krishtlindjeve në Pragë me rrugët e saj historike, tregjet festive dhe arkitekturën mahnitëse."
      },
    ...
    },
    {
      ...
      descriptionLong: {
        en: "Barcelona awaits you with festive lights, seaside walks and an atmosphere full of energy. Perfect vacation before the holidays with La Rambla, Sagrada Familia, tapas, and magical winter nights.",
        sq: "Barcelona ju pret me drita festive, shëtitje bregdetare dhe një atmosferë plot energji. Pushim perfekt para festave me La Rambla, Sagrada Familia, tapas dhe netë dimërore magjike."
      },
